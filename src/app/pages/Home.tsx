...
const translations = {
  pt: {
    nav: {
      services: "Serviços", expertise: "Expertise", portfolio: "Portfólio",
      infra: "Infraestrutura Cloud", cta: "Solicitar Avaliação Técnica",
    },
    hero: {
      badge: "Disponível para novos projetos",
      headline1: "Modernizando", headline2: "Codebases,", headline3: "Escalando Ideias.",
      ...
      cta1: "Vamos Conversar", cta2: "Ver Stack",
      stat1: "Anos de Engenharia", stat2: "Projetos Entregues", stat3: "SLA de Uptime",
    },
    terminal: {
      label: "nt-stack ~ análise", cmd: "$ nt analyze --repo monolito-legado",
      ...
      road1: "✓ Gerando roadmap de modernização...", road2: "✓ Esforço estimado: 8–12 sprints",
    },
    services: {
      badge: "Serviços Principais", heading1: "O que construímos,", heading2: "corrigimos e escalamos.",
      sub: "Serviços de engenharia de ponta a ponta para empresas que precisam de qualidade de nível expert — não de output júnior.",
      items: [
        { title: "Modernização de Código Legado", desc: "Eliminação sistemática de dívida técnica, anti-padrões e gambiarras. Refatoramos codebases para sistemas limpos, manuteníveis e de alto desempenho sem parar a entrega.", tags: ["Refactoring", "Dívida Técnica", "Anti-padrões"] },
        { title: "Correção de Bugs & Performance", desc: "Debug forense profundo em todo o stack. Caçamos race conditions, memory leaks e gargalos de performance que seu time não conseguiu resolver.", tags: ["Debug Forense", "Profiling", "APM"] },
        { title: "Redesign Arquitetural", desc: "Migração planejada de monólito para microserviços, DDD, CQRS, event sourcing e Clean Architecture — sem interrupção do negócio.", tags: ["Microserviços", "DDD", "Clean Arch"] },
        { title: "MVP & Desenvolvimento Greenfield", desc: "Do quadro branco ao software pronto para produção. Construímos MVPs escaláveis e seguros com o stack certo — não o da moda — com CI/CD desde o dia um.", tags: ["MVP", "Full-Stack", "Pronto p/ Launch"] },
        { title: "DevOps & Infraestrutura Zero-Ops", desc: "Além de estruturar e configurar projetos nas nuvens tradicionais — AWS, GCP, Digital Ocean — também construímos nuvens privadas a partir de qualquer VPS. Sem vendor lock-in.", tags: ["AWS", "Kubernetes", "CI/CD"] },
        { title: "Hardening de Segurança", desc: "Revisões de segurança baseadas em OWASP, prep para pentest, gestão de secrets e implementação de SSDLC. Fechamos as brechas antes que virem incidentes.", tags: ["OWASP", "Pen Testing", "SSDLC"] },
      ],
    },
    infra: {
      badge: "Infraestrutura Full-Stack", heading1: "Você entrega código.", heading2: "Nós cuidamos do resto.",
      ...
      features: ["AWS · GCP · Digital Ocean", "Nuvem privada em qualquer VPS", "Sem vendor lock-in", "Clusters com auto-scaling", "Backups e disaster recovery", "Deploys zero-downtime"],
      stackLabel: "// STACK COMPROVADO", pipelineLabel: "// STATUS DO PIPELINE CI/CD",
    },
    profile: {
      badge: "Por que NT Sistemas Web", heading1: "Rigor de engenharia,", heading2: "pragmatismo de negócio.",
      ...
      lang: "Linguagens", fw: "Frameworks", db: "Bancos de Dados",
    },
    contact: {
      badge: "Escope seu Projeto", heading1: "Inicie a", heading2: "conversa.",
      ...
      step1: "01 / Problema", step2: "02 / Detalhes",
      selectLabel: "Selecione tudo que se aplica:", continue: "Continuar",
      fields: {
        name: "Nome Completo", namePh: "Maria Silva",
        email: "E-mail Corporativo", emailPh: "maria@empresa.com",
        company: "Empresa / Projeto", companyPh: "Empresa Ltda.",
        budget: "Orçamento Aproximado", budgetPh: "R$ 20k–50k",
        stack: "Stack Atual", stackPh: "ex: Java Spring Boot, MySQL, AWS EC2, React...",
      ...
      back: "Voltar", submit: "Enviar Brief Técnico",
      successTitle: "Brief recebido.", successSub: "Responderemos com uma avaliação técnica em até 48 horas.",
    },
    footer: { copy: "© 2024 NT Sistemas Web · Todos os direitos reservados · Engenharia de Elite" },
  },
  en: {
    nav: {
      services: "Services", expertise: "Expertise", portfolio: "Portfolio",
      infra: "Cloud Infrastructure", cta: "Request Technical Assessment",
    },
    hero: {
      badge: "Available for new engagements",
      headline1: "Modernizing", headline2: "Codebases,", headline3: "Scaling Ideas.",
      ...
      cta1: "Let's Talk Tech", cta2: "View Stack",
      stat1: "Years Engineering", stat2: "Projects Delivered", stat3: "Uptime SLA",
    },
    terminal: {
      label: "nt-stack ~ analysis", cmd: "$ nt analyze --repo legacy-monolith",
      ...
      road1: "✓ Generating modernization roadmap...", road2: "✓ Estimated effort: 8–12 sprints",
    },
    services: {
      badge: "Core Services", heading1: "What we build,", heading2: "fix, and scale.",
      sub: "End-to-end software engineering services for companies that need expert-level quality — not junior output.",
      items: [
        { title: "Legacy Code Modernization", desc: "Systematic elimination of tech debt, anti-patterns, and 'gambiarras'. We refactor codebases to clean, maintainable, high-performance systems without stopping delivery.", tags: ["Refactoring", "Tech Debt", "Anti-patterns"] },
        { title: "Bug Fixing & Performance Tuning", desc: "Deep forensic debugging across the full stack. We hunt down elusive race conditions, memory leaks, and performance bottlenecks your team hasn't been able to solve.", tags: ["Forensic Debug", "Profiling", "APM"] },
        { title: "Architectural Redesign", desc: "Planned migration from monolith to microservices, domain-driven design, CQRS, event sourcing, and Clean Architecture — with zero business disruption.", tags: ["Microservices", "DDD", "Clean Arch"] },
        { title: "MVP & Greenfield Development", desc: "From whiteboard to production-ready software. We build scalable, secure MVPs using the right stack — not the trendy one — with proper CI/CD from day one.", tags: ["MVP", "Full-Stack", "Launch-Ready"] },
        { title: "DevOps & Zero-Ops Infrastructure", desc: "Beyond structuring projects on traditional clouds — AWS, GCP, Digital Ocean — we also build private clouds on top of any VPS. No vendor lock-in.", tags: ["AWS", "Kubernetes", "CI/CD"] },
        { title: "Security Hardening", desc: "OWASP-based security reviews, penetration testing prep, secrets management, and secure SDLC implementation. We close gaps before they become incidents.", tags: ["OWASP", "Pen Testing", "SSDLC"] },
      ],
    },
    infra: {
      badge: "Full-Stack Infrastructure", heading1: "You ship code.", heading2: "We handle the rest.",
      ...
      features: ["AWS · GCP · Digital Ocean", "Private cloud on any VPS", "Zero vendor lock-in", "Auto-scaling clusters", "Backups & disaster recovery", "Zero-downtime deploys"],
      stackLabel: "// PROVEN TECH STACK", pipelineLabel: "// CI/CD PIPELINE STATUS",
    },
    profile: {
      badge: "Why NT Sistemas Web", heading1: "Engineering rigor meets", heading2: "business pragmatism.",
      ...
      lang: "Languages", fw: "Frameworks", db: "Databases",
    },
    contact: {
      badge: "Scope Your Project", heading1: "Start the", heading2: "conversation.",
      ...
      step1: "01 / Pain Point", step2: "02 / Project Details",
      selectLabel: "Select all that apply:", continue: "Continue",
      fields: {
        name: "Full Name", namePh: "John Smith",
        email: "Work Email", emailPh: "john@company.com",
        company: "Company / Project", companyPh: "Acme Corp.",
        budget: "Approximate Budget", budgetPh: "$5k–20k",
        stack: "Current Tech Stack", stackPh: "e.g. Java Spring Boot, MySQL, AWS EC2, React...",
      ...
      back: "Back", submit: "Send Technical Brief",
      successTitle: "Brief received.", successSub: "We'll respond with a technical assessment within 48 hours.",
    },
    footer: { copy: "© 2024 NT Sistemas Web · All rights reserved · Elite Engineering" },
  },
} as const;

type T = typeof translations["pt"];
const LangContext = createContext<{ lang: Lang; t: T }>({ lang: "pt", t: translations.pt });
...
function LangToggle({ lang, setLang }: { lang: Lang; setLang: (l: Lang) => void }) {
  return (
    <div className="flex items-center rounded-lg p-0.5 border" style={{ borderColor: "rgba(124,58,237,0.25)", background: "rgba(124,58,237,0.07)" }}>
      {(["pt", "en"] as Lang[]).map((l) => (
        <button key={l} onClick={() => setLang(l)} className="px-2.5 py-1 rounded-md text-xs font-mono font-semibold transition-all duration-150"
          style={{ background: lang === l ? "rgba(124,58,237,0.5)" : "transparent", color: lang === l ? "#fff" : "#64748B" }}>
          {l.toUpperCase()}
        </button>
      ))}
    </div>
...
function Navbar({ lang, setLang }: { lang: Lang; setLang: (l: Lang) => void }) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b"
      style={{ borderColor: "rgba(124,58,237,0.15)", background: "rgba(15,23,42,0.88)", backdropFilter: "blur(16px)" }}>
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <a href="#" className="flex items-center gap-3">
          <NTLogo size={34} />
          <div>
            <span className="font-semibold text-base tracking-tight" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", color: "#fff" }}>NT Sistemas Web</span>
      ...
      {open && (
        <div className="md:hidden border-t px-6 py-4 flex flex-col gap-4"
          style={{ borderColor: "rgba(124,58,237,0.15)", background: "rgba(15,23,42,0.95)" }}>
          {links.map((l, i) => (
            <a key={l} href={hrefs[i]} className="text-sm font-medium" style={{ color: "#94A3B8" }} onClick={() => setOpen(false)}>{l}</a>
          ))}
          <a href="#contact" className="px-4 py-2 text-sm font-semibold rounded-lg text-center"
            style={{ background: "linear-gradient(135deg, #7C3AED, #6D28D9)", color: "#fff" }} onClick={() => setOpen(false)}>
            {t.nav.cta}
          </a>
        </div>
      )}
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden" style={{ background: "#0F172A" }}>
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-16 items-center">
        <div>
          <PillBadge><span className="w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse" />{h.badge}</PillBadge>
          <h1 className="mt-8 text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-[1.05] tracking-tight"
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {h.tags.map((tag) => (
              <span key={tag} className="text-xs font-mono px-2.5 py-1 rounded border"
                style={{ borderColor: "rgba(124,58,237,0.25)", color: "#7C3AED", background: "rgba(124,58,237,0.08)" }}>{tag}</span>
            ))}
          </div>
          ...
          <div className="mt-14 flex gap-10 flex-wrap">
            {[{ value: "10+", label: h.stat1 }, { value: "80+", label: h.stat2 }, { value: "99.9%", label: h.stat3 }].map((s) => (
              <div key={s.label}>
        ...
        <div className="hidden lg:block">
          <div className="rounded-2xl border overflow-hidden"
            style={{ borderColor: "rgba(124,58,237,0.25)", background: "rgba(30,27,75,0.6)", boxShadow: "0 0 60px rgba(124,58,237,0.15), inset 0 1px 0 rgba(255,255,255,0.04)" }}>
            ...
            <div className="p-6 font-mono text-sm" style={{ color: "#94A3B8" }}>
              ...
              <div className="mt-1 ml-4">
                {term.issues.map((i) => <div key={i.text} style={{ color: i.color }}>{i.sym} {i.text}</div>)}
              </div>
              <br />
              <div style={{ color: "#A78BFA" }}>{term.debt}</div>
              <div className="mt-1 ml-4 space-y-0.5" style={{ color: "#64748B" }}>{term.debtItems.map((d) => <div key={d}>{d}</div>)}</div>
              <br />
              ...
              <div className="flex items-center gap-1" style={{ color: "#7C3AED" }}>
                <span>$ </span><span className="w-2 h-4 animate-pulse" style={{ background: "#7C3AED" }} />
              </div>
            </div>
          </div>
        </div>
          ...
          {s.items.map((item, idx) => {
            ...
            return (
              <div key={item.title} className="group relative p-6 rounded-2xl border transition-all duration-300 cursor-default"
                ...
                onMouseLeave={(e) => { const el = e.currentTarget as HTMLElement; el.style.borderColor = "rgba(124,58,237,0.18)"; el.style.background = "rgba(30,27,75,0.35)"; el.style.transform = ""; el.style.boxShadow = ""; }}>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {item.tags.map((tag) => (
                    <span key={tag} className="text-[10px] font-mono px-2 py-0.5 rounded"
                      style={{ background: "rgba(124,58,237,0.1)", color: "#7C3AED", border: "1px solid rgba(124,58,237,0.2)" }}>{tag}</span>
                  ))}
                </div>
              </div>
            );
          ...
          <div>
            ...
            <div className="mt-10 grid grid-cols-2 gap-3">
              {inf.features.map((f, i) => {
                ...
                return (
                  <div key={f} className="flex items-center gap-3 p-3 rounded-xl border"
                    style={{ borderColor: "rgba(124,58,237,0.15)", background: "rgba(30,27,75,0.3)" }}>
          ...
          <div className="lg:col-span-2">
            <div className="relative inline-block">
              <div className="w-48 h-48 rounded-3xl flex items-center justify-center"
                style={{ background: "linear-gradient(135deg, #1E1B4B, #2E1065)", border: "1px solid rgba(124,58,237,0.3)", boxShadow: "0 0 60px rgba(124,58,237,0.2)" }}>
                <NTLogo size={72} />
              </div>
              <div className="absolute -bottom-3 -right-3 px-3 py-1.5 rounded-full text-xs font-mono font-semibold border"
                style={{ background: "rgba(34,197,94,0.1)", borderColor: "rgba(34,197,94,0.3)", color: "#22c55e" }}>
                <span className="inline-block w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse mr-1.5" />Staff Engineer
              </div>
            </div>
            <div className="mt-8">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-10 flex gap-4 flex-wrap">
              {[
                ...
                <div key={item.label} className="flex-1 min-w-[200px] p-4 rounded-xl border"
                  style={{ borderColor: "rgba(124,58,237,0.18)", background: "rgba(30,27,75,0.3)" }}>
      ...
      <div className="relative max-w-3xl mx-auto px-6">
        ...
        {submitted ? (
          ...
          <div className="rounded-2xl border overflow-hidden" style={{ borderColor: "rgba(124,58,237,0.25)", background: "rgba(30,27,75,0.4)" }}>
            ...
            <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="p-8">
              {step === 1 && (
                <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input type="text" placeholder={c.fields.stackPh} value={form.stack} onChange={(e) => setForm({ ...form, stack: e.target.value })}
                      className="w-full px-4 py-2.5 rounded-xl text-sm border outline-none" style={inputStyle}
                      onFocus={(e) => { (e.target as HTMLElement).style.borderColor = "rgba(124,58,237,0.6)"; }}
                      onBlur={(e) => { (e.target as HTMLElement).style.borderColor = "rgba(124,58,237,0.25)"; }} />
                  </div>
                  <div>
                    ...
                    <textarea rows={5} placeholder={c.fields.messagePh} value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })}
                      className="w-full px-4 py-2.5 rounded-xl text-sm border outline-none resize-none" style={inputStyle}
                      onFocus={(e) => { (e.target as HTMLElement).style.borderColor = "rgba(124,58,237,0.6)"; }}
                      onBlur={(e) => { (e.target as HTMLElement).style.borderColor = "rgba(124,58,237,0.25)"; }} />
                  </div>
                  <div className="flex gap-3 pt-2">
                    <button type="button" onClick={() => setStep(1)} className="px-5 py-3 rounded-xl text-sm font-medium border"
                      style={{ borderColor: "rgba(124,58,237,0.25)", color: "#64748B", background: "transparent" }}>{c.back}</button>
        ...
        <div className="flex gap-4">
          {["GitHub", "LinkedIn", "Email"].map((l) => (
            <a key={l} href="#" className="text-xs font-mono transition-colors" style={{ color: "#475569" }}
              ...
              onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.color = "#475569"; }}>{l}</a>
          ))}
        </div>
      </div>
    </footer>
